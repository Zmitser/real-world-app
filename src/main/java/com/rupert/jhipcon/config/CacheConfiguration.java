package com.rupert.jhipcon.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.rupert.jhipcon.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.rupert.jhipcon.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(com.rupert.jhipcon.domain.User.class.getName() + ".authorities", jcacheConfiguration);
